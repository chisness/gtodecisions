...
format:
  html:
    math: true
---
Salmon on a bed of pasta is my favorite meal in the world. Salmon on a bed of rice is for some reason the thing that I eat more frequently. My standard dinner is salmon with Costco stir-fry vegetables (frozen) sometimes with a cup of rice. (A dietician recently told me this is too much salmon/mercury.)
...
1. The Cheesecake Factory makes an excellent salmon (albeit farmed)
...
![](assets/salmon/restaurantbefore.jpg)
