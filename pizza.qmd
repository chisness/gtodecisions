...
## The Ratio Equation
**This is the important equation that you should use in real life pizza value scenarios!** Let Pizza 1 be the larger one. 
...
\begin{equation}
\begin{split}
\text{Sq In. per Dollar} &= \frac{p_2*d_1^2}{p_1*d_2^2} \\
...
This shows us that Pizza 1 is about 1.97 better value than Pizza 2 (in terms of square inches per dollar)! 